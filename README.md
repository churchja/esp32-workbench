...
| `tools/cmpflash.py` | Compare two flash images region by region; separates a booted board from a failed restore |
...
| HoneyHoney Lab ESP32 Marauder Double Barrel *(owner-confirmed)* | `ESP32-D0WD-V3` | `esp32` | 4MB | none | `CH340 bridge` | 5 | **230400** | `489d31027e98` |
